...
class MobSkill extends StatelessWidget {
  const MobSkill({super.key});
...
class MobHoverContainer extends StatefulWidget {
  final String image;
  final String Text1;
  final String Text2;

  const MobHoverContainer({
    super.key,
    required this.image,
    required this.Text1,
    required this.Text2,
  ...
  @override
  _MobHoverContainerState createState() => _MobHoverContainerState();
}

class _MobHoverContainerState extends State<MobHoverContainer> {
  bool isTapped = true;
  @override
  Widget build(BuildContext context) {
    ...
    final text2Size = (height + width) / 140;
